...
if (process.env.ONYX_COMMIT || process.env.ONYX_HTTP_COMMIT || process.env.ONYX_EDA_COMMIT) {
  ...
  if (process.env.ONYX_EDA_COMMIT) {
    console.log(`Updating onyx-eda commit to ${process.env.ONYX_EDA_COMMIT}`)

    delete doc.dependencies['onyx-eda'].version
    doc.dependencies['onyx-eda'].commit = process.env.ONYX_EDA_COMMIT
  }
